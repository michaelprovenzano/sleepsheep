      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:8000/api/v1/users/reset-password/".concat(token),
              data: {
...
exports.updateASleeplog = exports.deleteASleeplog = exports.createASleeplog = void 0;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:8000/api/v1/sleepLogs/".concat(id)
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:8000/api/v1/trackables/".concat(id)
            });
...
var sleeplogChart = function sleeplogChart(labels, data, trackables) {
  ...
  var myChart = document.getElementById('my-chart'); // console.log({ labels, data, trackables });
...
var trackableChart = function trackableChart(labels, sleepQuality, insomnia, trackables) {
  ...
  var _loop = function _loop(thisData) {
    ...
    console.log(limitedData); // Add arrays for dotted lines
...
var dashboard = document.querySelector('.dashboard'); // Initalize loader
