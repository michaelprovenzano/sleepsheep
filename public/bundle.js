...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"Today.js":[function(require,module,exports) {
"use strict";
...
},{}],"../../node_modules/pickadate/builds/index.js":[function(require,module,exports) {
var define;
var global = arguments[3];
var process = require("process");
...
if (newSleeplogForm) {
  var today = new _Today.default();
  document.querySelector('.sleeplog-date__day').innerText = today.date.toLocaleString('en-US', {
    weekday: 'long'
  });
  document.querySelector('.sleeplog-date__date').innerText = today.date.toLocaleString('en-US', {
    month: 'long',
    day: 'numeric',
    year: 'numeric'
  });
  ...
  document.getElementById('wakeup-time').value = today.sleepEndTime; // pre-fill form if one was already started
...
function sleeplogFormData() {
  var sleepStartDate = document.getElementById('sleep-date').value;
  var sleepStartTime = document.getElementById('sleep-time').value;
  var sleepEndDate = document.getElementById('wakeup-date').value;
  var sleepEndTime = document.getElementById('wakeup-time').value;
